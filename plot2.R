...
household_power_consumption <- read.table("C:/Users/adale/Desktop/Statistics AUEB Postgrad/Coursera/Exploratory Data Analysis/Project 1/household_power_consumption.txt", header=TRUE, sep=";", stringsAsFactors=FALSE, dec=".")
